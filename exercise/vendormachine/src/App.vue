        ...
        <div class="w3-content">
          <div class="w3-row"><br>
            ...
            <div class="w3-quarter">
              <p>Coin10</p>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT_wIh0gr7owWGDjM84jCZrZugYRK_aEKRQoJAiCPSHujj-uMbV" alt="coin10"
                @click="BtInc('coin10')" style="width:45%" class="w3-circle w3-hover-opacity">
              </div>
            <div class="w3-quarter">
              <p>Coin5</p>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT_wIh0gr7owWGDjM84jCZrZugYRK_aEKRQoJAiCPSHujj-uMbV" alt="coin5"
                @click="BtInc('coin5')" style="width:45%" class="w3-circle w3-hover-opacity">
            </div>
            <div class="w3-quarter">
              <p>Coin2</p>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT_wIh0gr7owWGDjM84jCZrZugYRK_aEKRQoJAiCPSHujj-uMbV" alt="coin2"
                @click="BtInc('coin2')" style="width:45%" class="w3-circle w3-hover-opacity">
              
            </div>
            <div class="w3-quarter">
               <p>Coin1</p>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT_wIh0gr7owWGDjM84jCZrZugYRK_aEKRQoJAiCPSHujj-uMbV" alt="coin1"
                @click="BtInc('coin1')" style="width:45%" class="w3-circle w3-hover-opacity">
            </div>
            <br>
            <div>
              <!--ส้่่วนของ Modal มี 2 แบบ-->
              <!-- แบบ 1-->
              <b-modal ref="my-modal" no-close-on-esc no-close-on-backdrop hide-header-close
               class="no-close-on-esc" hide-footer title="thank you for your service">
                <div class="d-block ">
                  <h3>You Got this</h3>
                  <h4>{{productSelect}}</h4>
                  ...
                  <b-button class="mt-3" variant="outline-danger"
                   block @click="reset()">Close Me</b-button>
                </div>
              </b-modal>
            <!-- แบบ 2-->
              <b-modal ref="my-modal1" no-close-on-esc no-close-on-backdrop hide-header-close
               class="no-close-on-esc" hide-footer title="thank you for your service">
                <div class="d-block ">
                 <h3><li>No coins to Change</li>
